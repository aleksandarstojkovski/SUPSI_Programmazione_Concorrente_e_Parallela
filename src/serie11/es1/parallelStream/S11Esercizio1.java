package serie11.es1.parallelStream;
...
public class S11Esercizio1 {
	...
	public static void main(final String[] args) {
		...
		Earthquake piuLontano = quakes.stream().parallel()
		...
		startTime = System.currentTimeMillis();
		Earthquake piuForte = quakes.stream().parallel()
		...
		startTime = System.currentTimeMillis();
		List<Earthquake> earthquakes = quakes.stream().parallel()
		...
		startTime = System.currentTimeMillis();
		long number = quakes.stream().parallel()
		...
		startTime = System.currentTimeMillis();
		Map<Integer,Integer> map = quakes.stream().parallel()
		...
		startTime = System.currentTimeMillis();
		Map<Integer,Integer> map2 = quakes.stream().parallel()
